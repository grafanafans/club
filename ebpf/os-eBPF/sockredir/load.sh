...
clang -O2 -g -target bpf -I/usr/include/linux/ -I/usr/src/linux-source-5.15.0/linux-source-5.15.0/include -c bpf_sockops_v4.c -o bpf_sockops_v4.o
...
clang -O2 -g -Wall -target bpf -I/usr/include/linux/ -I/usr/src/linux-source-5.15.0/linux-source-5.15.0/include -c bpf_tcpip_bypass.c -o bpf_tcpip_bypass.o
